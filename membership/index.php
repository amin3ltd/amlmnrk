...
<body>
    ...
    <nav class="fw-bold navbar navbar-expand-lg navbar-light bg-light position-fixed bg-gradient text-dark bg-opacity-0 w-100" id="topNavBar" style="z-index:2">
        <div class="container">
            ...
            <div class="collapse navbar-collapse " id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'home')? 'active' : '' ?>" aria-current="page" href="./"></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'vacancy')? 'active' : '' ?>" href="./?page=vacancy"></a>
                    </li>
                </ul>
            </div>
            <div>
            <div class="dropdown">
                <a class="btn btn-secondary bg-transparent  text-light border-0" href="./admin/login" >
                   Admin Login
                </a>
            </div>
            </div>

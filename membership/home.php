...
<div class="w-100 h-100">
    <header id="cover">
        <div class="container-fluid h-100 d-flex justify-content-end align-items-end">
            <div class="w-100 py-3 pb-5 d-flex  justify-content-center ">
                <a href=".?page=vacancy" class="btn btn btn-primary px-4 btn-lg rounded-0 fs-4 fw-bold wow slideInLeft">Explore Services</a>
            </div>
        </div>
    </header>
    <div class="flex-grow-1 bg-light mb-0">
        ...
        <section class="bg-light bg-gradient text-light wow bounceInUp">

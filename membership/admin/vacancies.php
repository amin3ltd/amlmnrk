...
<script>
    $(function(){
        $('#create_new').click(function(){
            uni_modal('Add New Service',"manage_vacancy.php",'large')
        })
        $('.edit_data').click(function(){
            uni_modal('Edit Service Details',"manage_vacancy.php?id="+$(this).attr('data-id'),'large')
        })
        $('.view_data').click(function(){
            uni_modal('Service Details',"view_vacancy.php?id="+$(this).attr('data-id'),'large')
        })
        $('.delete_data').click(function(){
            _conf("Are you sure to delete <b>"+$(this).attr('data-name')+"</b> from Service List?",'delete_data',[$(this).attr('data-id')])
        })
